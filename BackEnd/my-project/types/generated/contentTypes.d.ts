...
export interface ApiBandmemberBandmember extends Schema.CollectionType {
  collectionName: 'bandmembers';
  info: {
    singularName: 'bandmember';
    pluralName: 'bandmembers';
    displayName: 'Bandmembers';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiSongSong extends Schema.CollectionType {
  ...
  attributes: {
    ...
    album: Attribute.Relation<
      ...
      'api::album.album'
    >;
    musicvideo: Attribute.String;
    releasedate: Attribute.Date;
    isSingle: Attribute.Boolean;
    singleCover: Attribute.Media;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::bandmember.bandmember': ApiBandmemberBandmember;
